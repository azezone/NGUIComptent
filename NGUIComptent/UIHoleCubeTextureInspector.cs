...
[CustomEditor(typeof(UIHoleCubeTexture), true)]
public class UIHoleCubeTextureInspector : UIWidgetInspector
{
    UIHoleCubeTexture mTex;
    ...
    protected override bool ShouldDrawProperties()
    {
        ...
        mTex.Radis = EditorGUILayout.FloatField("Radis",mTex.Radis);
        //DrawLegacyFields();
